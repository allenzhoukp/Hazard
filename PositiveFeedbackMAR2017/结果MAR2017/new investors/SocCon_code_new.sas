...
proc sql;
create table warrant_expand1 as select distinct a.*,b.wrprice as lag1_wrprice,b.changepercent as lag1_market_ret,b.changeratio as lag1_turnover,b.wrprice-b.p2 as lag1_bs,1-b.exprice/b.stockprice as lag1_fundamental from warrant_expand a left join warrant.warranttrans b
...
on a.fundacctnum=b.fundacctnum and a.securitycode=b.securitycode and a.date>=b.start and a.date<=b.end;
quit;
